    ...
    render() {
        return (
            <View style={styles.container}>
                <TouchableOpacity  onPress={()=>{Linking.openURL(`tel:${Object.values(this.state.data)[2]}`);}} >
                ...
                <TouchableOpacity  onPress={this._goToCJC} >
                       <Image source={require('CJC/images/social/location.png')}
                        style={{width: 25,height: 25,resizeMode:'contain',flex: 1,zIndex:20,tintColor:'#97A8A9'}}/>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>Linking.openURL(Object.values(this.state.data)[4])} >
                ...
                <TouchableOpacity  onPress={()=>Linking.openURL(Object.values(this.state.data)[9])} >
